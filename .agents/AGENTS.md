...
4. **Mandatory QA Handoff**: The Orchestrator MUST automatically invoke `qa_agent` immediately after `coder_agent` reports completing any code changes. The Orchestrator MUST wait for QA's approval before notifying the user that the feature is ready.
